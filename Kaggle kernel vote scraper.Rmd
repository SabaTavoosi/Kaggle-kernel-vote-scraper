...
<font size ="4"> **Votes needed for each medal**</font>  
(votes by novices, self-votes, and old votes are not counted towards medals)
...
* The app does not recognize self-votes by kernel authors and, thus, counts them towards valid votes. Subtract the valid votes by 1 if the author has cast a self-vote for accurate votes towards medals.  
...
This app was made just for fun and is not affiliated with Kaggle. 

Feel free to check out my kaggle profile and kernels at <https://www.kaggle.com/tavoosi>  
